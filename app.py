...
if st.sidebar.button("Run Simulation"):
    ...
    if uploaded_orders is not None:
        ...
        # Generate new orders based on uploaded data
        orders = generate_orders_from_uploaded_data(orders_df)
        st.subheader("Generated Synthetic Orders")
        st.dataframe(orders)
    else:
    ...
    alerts = engine.evaluate(orders.to_dict(orient="records"), trades, market_depth)
